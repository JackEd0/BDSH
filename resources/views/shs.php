...
<div id="menu">
    <div class="">
        ...
        <ul>
            <li><a class="home_logo" href="<?php echo(URL::route('signup')) ?>">Inscription</a></li>
            <li><a class="home_logo" href="<?php echo(URL::route('auth')) ?>">Connexion</a></li>
        </ul>
        <br class="clear">
    </div>
</div>
...
<div class="wrapper">
    <a class="monimage2" href="#"><img src="http://puu.sh/naFf1/8f51654e89.jpg"></a>
    <style>
        .monimage2 {
            margin-left:10%;
        }
