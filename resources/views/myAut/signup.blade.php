 ...
 * Time: 11:11
 */
$subbar = 1; //active le menu inscription
?>
...
@section('content')
    <div class="" style="display: block; text-align: center; margin: auto; max-width: 60%;">
        <form class="form-signin" id="register" method="post">
            ...
            <input type="hidden" name="_FORM_VALIDATED" id="__EVENTTARGET" value="OUEP"/>
            <input type="hidden" name="_OBJECT_ID" id="__EVENTTARGET" value=""/>

            <h1 class="form-signin-heading">Inscription</h1>

            <div class="form-group col-md-6" style="text-align:left;">
                <label for="inputLogin" class="control-label">Nom d'utilisateur *</label>
                <input type="text" id="inputLogin" class="form-control" placeholder="Nom d'utilisateur" required autofocus><br/>
                <label for="inputName" class="control-label">Nom *</label>
                <input type="text" id="inputName" class="form-control" placeholder="Nom" required autofocus><br/>
                <label for="inputFName" class="control-label">Prénom(s) *</label>
                <input type="text" id="inputFName" class="form-control" placeholder="Prénom(s)" autofocus><br/>
                <label for="inputEmail" class="control-label">Email *</label>
                <input type="email" id="inputEmail" class="form-control" placeholder="Email" autofocus><br/>
                <label for="inputPassword" class="control-label">Mot de passe *</label>
                <input type="password" id="inputPassword" class="form-control" placeholder="Mot de passe" required><br/>
                <label for="inputVPassword" class="control-label">Confirmer *</label>
                <input type="password" id="inputVPassword" class="form-control" placeholder="Confirmer" autofocus><br/>
            </div>
            <div class="form-group col-md-6" style="text-align:left;">
                <label for="inputAddress" class="control-label">Adresse *</label>
                <input type="text" id="inputAddress" class="form-control" placeholder="Adresse" autofocus><br/>
                <label for="inputTown" class="control-label">Ville *</label>
                <input type="text" id="inputTown" class="form-control" placeholder="Ville de résidence" autofocus><br/>
                <label for="inputCP" class="control-label">Code Postal *</label>
                <input type="text" id="inputCP" class="form-control" placeholder="Code Postal *" autofocus><br/>
                <label for="inputProvince" class="control-label">Province *</label>
                <input type="text" id="inputProvince" class="form-control" placeholder="Province" autofocus><br/>
                <label for="inputCountry" class="control-label">Pays *</label>
                <input type="text" id="inputCountry" class="form-control" placeholder="Pays de résidence" autofocus><br/>
                <label for="inputTel" class="control-label">Téléphone</label>
                <input type="text" id="inputTel" class="form-control" placeholder="Téléphone" autofocus><br/>
            </div>
            <p><br/>
...
@stop
<?php if (isset($_POST['_FORM_VALIDATED'])) {
    $inputName = $_POST['inputName'];
    $inputPassword = $_POST['inputPassword'];
    $user = new \App\User();
    $user::create(['username' => $inputName,
            'password' => Hash::make($inputPassword),]);
}
?>
<?php //script from http://code.jquery.com/jquery-1.11.2.min.js ?>
<script>
...
<script>
    jQuery(document).ready(function () {
        ...
        jQuery("#register").submit(function () {
            ...
            if (jQuery("#inputVPassword").val() == "") {
                alert("Merci de saisir la vérification de votre mot de passe");
                jQuery("#inputVPassword").focus();
                return false;
            }
            if (jQuery("#inputPassword").val() != jQuery("#inputVPassword").val()) {
                alert("Merci de reonfirmer le mot de passe");
                jQuery("#inputVPassword").focus();
                return false;
            }
            if (jQuery("#inputAddress").val() == "") {
                alert("Merci de saisir votre adresse");
                jQuery("#inputAddress").focus();
                return false;
            }
            if (jQuery("#inputCountry").val() == "") {
                alert("Merci de saisir votre pays de résidence");
                jQuery("#inputCountry").focus();
                return false;
            }
            if (jQuery("#inputTown").val() == "") {
                alert("Merci de saisir votre ville de résidence");
                jQuery("#inputTown").focus();
                return false;
            }
