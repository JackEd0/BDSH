    ...
    <div class="" style="display: block; text-align: center; margin: auto; max-width: 40%;">
        <form class="form-signin" id="register" method="post">
            ...
            <div class="form-group" style="text-align:left;">
                <label for="inputLogin" class="control-label">Nom d'user</label>
                <input type="text" id="inputLogin" disabled="disabled" class="form-control" placeholder="Nom d'user" value="{{ $user->username }}" required autofocus><br/>
                <label for="inputName" class="control-label">Nom</label>
                <input type="text" id="inputName" disabled="disabled" class="form-control" placeholder="Nom" value="{{ $user->name }}" required autofocus><br/>
                <label for="inputEmail" class="control-label">Email</label>
                <input type="email" id="inputEmail" disabled="disabled" class="form-control" placeholder="Email" value="{{ $user->email }}" autofocus><br/>
