/**
 * Created by fanm2101 on 2016-11-09.
 */
...
$(document).ready(function(){
    ...
    if (bodyText.indexOf('imageName') == -1) {
        $('#cardReportTable').DataTable({
            dom: 'Bfrtip',
            buttons: [
...
function sendForm (selector) {
    ...
    var includeCardWithImages = $('input[name="includeCardWithImages"]:checked').val();

    var url = "/report/generateSpecificReport/" + selector + '/' + includeCardWithImages + "/" + startDate + "/" + endDate;
